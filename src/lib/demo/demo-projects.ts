...
export const DEMO_PROJECT_SHOPSTREAM: ArchitectureAnalysis = {
...
export const DEMO_PROJECT_COLLABCANVAS: ArchitectureAnalysis = {
...
export const DEMO_PROJECTS = [DEMO_PROJECT_SHOPSTREAM, DEMO_PROJECT_COLLABCANVAS];
