...
exports.ARCHITECTURE_ANALYSIS_SYSTEM_PROMPT = void 0;
exports.buildAnalysisUserPrompt = buildAnalysisUserPrompt;
exports.buildChatSystemPrompt = buildChatSystemPrompt;
exports.buildAdHocFlowPrompt = buildAdHocFlowPrompt;
exports.ARCHITECTURE_ANALYSIS_SYSTEM_PROMPT = `
...
`;
function buildAnalysisUserPrompt(documentText, fileName) {
    return `
...
function buildChatSystemPrompt(projectSummaryJson, retrievedChunksText, mode = 'developer') {
...
function buildAdHocFlowPrompt(projectSummaryJson, documentContext, actionQuery) {
    return `
